	...
	(function() {
		...
		*/
		...
		var _ = (function runInContext(context) {
			...
			var Array$1 = context.Array, Date = context.Date, Error = context.Error, Function$1 = context.Function, Math = context.Math, Object$1 = context.Object, RegExp$1 = context.RegExp, String = context.String, TypeError = context.TypeError;
			...
			*/
			...
			var DataView = getNative(context, "DataView"), Map = getNative(context, "Map"), Promise$1 = getNative(context, "Promise"), Set = getNative(context, "Set"), WeakMap = getNative(context, "WeakMap"), nativeCreate = getNative(Object$1, "create");
			...
			*/
			var createSet = !(Set && 1 / setToArray(new Set([, -0]))[1] == INFINITY) ? noop : function(values$1) {
